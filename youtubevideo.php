...
Current Author: http://www.soslidesigns.com
...
class ryv_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'ryv_widget', // Base ID
			__('Random YT Video', 'text_domain'), // Name
			array( 'description' => __( 'Random YT Video', 'text_domain' ), ) // Args
		);
	}
    ...
    function widget($args, $instance) {
		...
		$url=$video[0]->url; $name=$video[0]->titel;
            ...
            $widget = "<iframe width='$width' height='$height' src='//www.youtube.com/embed/$url?$autoplay' frameborder='0' allowfullscreen></iframe>";
            echo $before_widget;
...
// register ryv_Widget widget
function register_ryv_widget() {
    register_widget( 'ryv_Widget' );
}
