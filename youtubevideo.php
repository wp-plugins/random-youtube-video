...
function ryv_adminpage(){
	...
	<div class="wrap">
		...
		<form name="ryv" method="post" action="options-general.php?page=youtubevideo.php">
			<fieldset class="options">
				...
				<table width="80%" cellspacing="2" cellpadding="3" class="editform" id="greattable">
					<tr style="background-color:#464646;color:white;">
						...
						<th style="text-align: center;">Video URL (From Embed Code)</th>
					</tr>
					<?
...
function ryv_widget(){
	...
	function ryv_mywidget($args) {
		...
		?>
		<div align="center">
			<font style="font-size:10px;"><? echo $name; ?></font>
			<object width="170" height="140"><param name="movie" value="<? echo $url; ?>"></param><param name="wmode" value="transparent"></param><embed src="<? echo $url; ?>" type="application/x-shockwave-flash" wmode="transparent" width="170" height="140"></embed></object>
		</div>
...
function ryv_install(){
	global $wpdb;
	$sql =  "CREATE TABLE `".$wpdb->prefix."randomyoutube` (
...
add_action('activate_youtubevideo.php', 'ryv_install');
